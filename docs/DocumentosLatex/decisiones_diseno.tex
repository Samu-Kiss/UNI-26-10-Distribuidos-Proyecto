...
Sistema completo en operación &
1.~Enviar \texttt{control\_\allowbreak manual} (INT-A1, VERTICAL, 5 ticks). 2.~Observar suspensión de lógica automática. 3.~Verificar retorno. &
\texttt{INT-A1}, \texttt{VERTICAL}, 5 ticks &
